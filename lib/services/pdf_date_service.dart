...
class PdfDateService {
  ...
  static Future<String> generatePdfWithDate() async {
    ...
    // 4. Get page size to calculate bottom position
    ...
    // 6. Add date text at bottom-left of the last page
    // Position: 20 from left, 30 from bottom
    page.graphics.drawString(
      todayDate,
      PdfStandardFont(PdfFontFamily.helvetica, 12),
      bounds: Rect.fromLTWH(20, pageHeight - 30, 200, 20),
